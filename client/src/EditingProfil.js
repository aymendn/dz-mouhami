...
const EditingProfil = () => {
    ...
    <div>
        ...
        <h1 className="text-3xl m-8 font-semibold text-[#094B72]">Edit your profil</h1>

        <label htmlFor="imageInput" className="block text-md m-6 font-medium text-[#094B72] ">
        Upload a Picture
      </label>
        ...
        <div
          ...
          style={{
            backgroundImage: selectedImage
              ...
              : 'url(https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1361&q=80)', 
          }}
        ></div>
        {selectedImage && (
          <div className="ml-3">
