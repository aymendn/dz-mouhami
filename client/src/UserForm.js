    ...
    <div>
      ...
      <div className="mt-8  text-center ">
        ...
        <p className="p-4 text-[#496C80] text-md text-center ">
          Welcome to DZ-Mouhami! By creating an account, you'll gain access to
          a network of trusted lawyers in Algeria. Please fill out the form
        ...
        <div className="grid grid-cols-2 gap-6 my-8 mx-64">
          <div className="mb-4">
            ...
            <input
              ...
              id="name"
              name="name"
              className="mt-1 p-2 rounded-2xl bg-slate-50 required hover:bg-slate-100 border border-gray-300 w-96"
              placeholder="John"
            />
          </div>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              id="email"
              name="email"
              className="mt-1 p-2 rounded-2xl bg-slate-50 border border-gray-300 w-96"
