    ...
    <div>
      ...
      <div className="flex flex-col items-center gap-4 my-8">
        ...
        <div className="mt-8 text-center">
          <h1 className="text-[#0F3146] text-5xl font-semibold">Lawyer Registration</h1>
        ...
        <form className="mx-4 md:mx-16 lg:mx-32">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
            ...
            <div className="mb-4">
              <label htmlFor="Specification" className="block text-sm font-medium text-[#103F5BE5]">
                Legal Specification
              </label>
              <div className="">
                <select id="Specification" name="Specification" autoComplete="Specification-name" className="mt-1 p-2 rounded-2xl bg-slate-50 required hover:bg-slate-100 border border-gray-300 w-full md:w-96 ring-inset ring-slate-50 focus:ring-0 focus:ring-inset focus:ring-slate-600">
            ...
            <div className="mb-4">
              <label htmlFor="Lawfirm" className="block text-sm font-medium text-[#103F5BE5]">
                Lawfirm
              </label>
              <input
                type="text"
